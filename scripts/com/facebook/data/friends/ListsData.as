package com.facebook.data.friends
{
   ...
   public class ListsData implements IEventDispatcher
   {
      ...
      public function set flid(param1:Number) : void
      {
         var _loc2_:Object = this._3145825flid;
         if(_loc2_ !== param1)
         {
            this._3145825flid = param1;
            this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"flid",_loc2_,param1));
         }
      }
