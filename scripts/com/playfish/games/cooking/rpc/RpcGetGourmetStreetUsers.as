package com.playfish.games.cooking.rpc
{
   ...
   public class RpcGetGourmetStreetUsers extends RpcBase
   {
      ...
      public function RpcGetGourmetStreetUsers(param1:int)
      {
         super();
         this.count = param1;
      }
      
      private function onGetGourmetStreetUsersOK(param1:Array) : void
      {
         var _loc3_:GameUser = null;
         var _loc4_:RpcEvent = null;
         Debug.out("onGetGourmetStreetUsersOK");
         newUsers = new Array();
         var _loc2_:Number = 0;
         ...
         newUsers = GameWorld.sortUsers(newUsers,GameWorld.compareUserRatingAscending);
      ...
      {
         GameWorld.rpcClient.getGourmetStreetUsers(count,onGetGourmetStreetUsersOK,onGetGourmetStreetUsersFail);
         return true;
      }
      
      private function onGetGourmetStreetUsersFail() : void
      {
         Debug.out("onGetGourmetStreetUsersFail");
